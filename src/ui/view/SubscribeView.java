...
public class SubscribeView extends View implements ActionListener {
    ...
    private void subscribe(){
    	String login = loginField.getText(); // Va servir pour la cr�ation du panier si le compte est cr��
    	boolean error = false;
    	...
    	if(!error){
    		...
    		if(subscribeError != null){
    			...
    			userFacade.createShoppingCart(userId); // on cr�e un panier pour le compte
